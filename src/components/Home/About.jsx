        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              Hi, my name is <span className="yellow">Roshan Kumara </span>
              and I'm from{" "}
              <span className="yellow"> Beliaththa, Sri Lanka.</span>
              <br />
              <br />I completed Bachelor's degree in{" "}
              ...
              <br />
              <br />
              As a<b className="yellow"> Software Engineer </b>, I enjoy
              tackling new challenges and continuously expanding my skill set.
              <br />
              ...
              <b className="yellow"> Node.js, MongoDB, SQL, Firebase</b> and
              modern Javascript libraries and frameworks &nbsp; like
              <i>
                <b className="yellow"> React.js , Electron JS </b>
              </i>
              <br />
